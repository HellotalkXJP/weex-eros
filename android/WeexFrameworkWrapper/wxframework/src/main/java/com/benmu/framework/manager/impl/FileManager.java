...
public class FileManager extends Manager{
    public static final String BASE_PATH = "benmu";
    public static final String APP_DIR = "/data/data/com.benmu.jyt/benmu";
    ...
    public static final String TEMP_CHECK = "check";
    ...
    private static File getPath(String fileName, Context context) {
        File file = new File(getBathPath(context), fileName);
        if (!file.exists()) {
            file.mkdirs();
        }
        return file;
    ...
    public static File getBathPath(Context context) {
    ...
    public static File getAppPath(String path, Context context) {
        File appFile = new File(getBathPath(context), path);
        if (!appFile.exists()) {
            appFile.mkdirs();
        }
    ...
    public static File getTempCheckDir(Context context) {
        return getAppPath(JS_TEMP_REPERTORY + File.separator + TEMP_CHECK, context);
    }
