...
//                        activity.mLoading = loading;
//                        activity.mLoading.show();
//                    }
//                } else {
//                    if (!activity.mLoading.isShowing() && !activity.isFinishing() && Looper
...
//                }
        ...
        public static void dismissLoading(Context context) {
            if (context instanceof AbstractWeexActivity) {
                AbstractWeexActivity activity = (AbstractWeexActivity) context;
                //TODO
//                if (activity.mLoading != null && activity.mLoading.isShowing() && !activity
//                        .isFinishing() && Looper
//                        .myLooper() == Looper.getMainLooper()) {
//                    activity.mLoading.dismiss();
//                }
            }
